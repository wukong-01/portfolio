...
export function IntroSection() {
  return (
    <section id="intro" className="flex min-h-screen scroll-mt-24 flex-col justify-center py-12 sm:py-16">
      <motion.div
      ...
      >
        ...
        <div className="relative grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-stretch lg:gap-8">
          ...
          <div className="marquee-container marquee-mask relative h-[380px] overflow-hidden sm:h-[520px] lg:h-[560px]">
